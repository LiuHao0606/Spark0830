package com.atguigu.gmall083001.mock

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.atguigu.gmall083001.common.util.{RandomNumUtil, RandomOptions}
import com.atguigu.gmall083001.mock.util.LogUploader
