package com.atguigu.gmall0831.mock

import java.util.Date

import com.alibaba.fastjson.{JSON, JSONObject}
import com.atguigu.gmall0831.common.util.{RandomNumUtil, RandomOptions}
import com.atguigu.gmall0831.mock.util.LogUploader
